...
Proof. intros P Q.
  ...
  (*MP Syll 2_06a Perm1_4a.
Qed. This proof is done but for an error message: "got 2 extra arguments".*)
  auto.
Qed.
...
Proof. intros P Q R.
  ...
  apply Comm2_04a.
  apply n2_75a.
  (*MP Comm 2_04a n2_75a. This wouldn't work because "illegal tactic; two extra args."*)
Qed.
...
Ltac Conj H1 H2 :=
  match goal with 
    | [ H1 : ?P, H2 : ?Q |- _ ] => 
      assert (P ∧ Q) by (specialize Conj3_03 with P Q; intros Conj3_03; MP Conj3_03 P; MP Conj3_03 Q)
end.

(*Theorem Conj : ∀ P Q : Prop, P→Q→(P∧Q).
Proof. intros P Q. specialize Conj3_03 with P Q. intros Conj3_03. left. intros Pp. intros Qq. MP Conj3_03 P. MP Conj3_03 Q. apply Conj3_03. (* split. apply Pp. apply Qq.
  specialize Conj3_03 with P Q. intros Conj3_03a Pp Qq.
  MP Conj3_03a P. MP Conj3_03a Q. apply Conj3_03a.*)
  (*assert (Q∧P). split. apply Hq. apply Hp. apply H. *)
Qed.*)
...
Axiom Equiv4_01 : ∀ P Q : Prop, (P↔Q)=((P→Q) ∧ (Q→P)).
(*n4_02 defines P iff Q iff R as P iff Q AND Q iff R.*)

Ltac Conj H1 H2 :=
  match goal with 
    | [ H1: ?P, H2: ?Q |- _ ] => 
      assert (H1 ∧ H2) by (specialize Conj3_03 with H1 H2; intros p; MP p H1; MP p H2)
end. 

Ltac Equiv H1 H2 :=
  match goal with 
    | [ H1 : ?P→?Q, H2 : ?Q→?P |- _ ] => 
      assert (P ↔ Q) by (specialize Equiv4_01 with P Q; 
        intros Equiv4_01; Prod ((P→Q)∧(Q→P)); apply Equiv4_01)
end. 

Theorem Trans4_1 : ∀ P Q : Prop,
  (P → Q) ↔ (~Q → ~P).
Proof. intros P Q.
  specialize Trans2_16 with P Q. intros Trans2_16a.
  specialize Trans2_17 with P Q. intros Trans2_17a.
  specialize Conj3_03 with ((P→Q)→(~Q→~P)) ((~Q→~P)→(P→Q)). intros Conj3_03a.
  MP Conj3_03a Trans2_16a.
  MP Conj3_03a Trans2_17a.
  replace (((P → Q) → ¬ Q → ¬ P) ∧ ((¬ Q → ¬ P) → P → Q)) with ((P → Q) ↔ (~Q → ~P)) in Conj3_03a.
  apply Conj3_03a.
  apply Equiv4_01.
Qed.
