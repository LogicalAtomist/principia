...
Theorem n3_26 : ∀ P Q : Prop,
  (P ∧ Q) → P.
Proof. intuition.
Qed.

Theorem n3_27 : ∀ P Q : Prop,
  (P ∧ Q) → Q.
Proof. intuition.
Qed.

Theorem n3_3 : ∀ P Q R : Prop,
  ((P ∧ Q) → R) → (P → (Q ∧ R)).
Admitted.

Theorem n3_31 : ∀ P Q R : Prop,
  (P → (Q ∧ R)) → (P ∧ Q) → R.
Admitted.

Theorem n3_33 : ∀ P Q R : Prop,
  ((P → Q) ∧ (Q → R)) → (P → R).
Proof. intuition.
Qed.

Theorem n3_34 : ∀ P Q R : Prop,
  ((Q → R) ∧ (P → Q)) → (P → R).
Proof. intuition.
Qed.

Theorem n3_35 : ∀ P Q : Prop,
  (P ∧ (P → Q)) → Q.
Proof. intuition.
Qed.
...
Theorem n4_1 : ∀ P Q : Prop,
  (P → Q) ↔ (~Q → ~P).
Admitted.

Theorem n4_11 : ∀ P Q : Prop,
  (P ↔ Q) ↔ (~P ↔ ~Q).
Admitted.
